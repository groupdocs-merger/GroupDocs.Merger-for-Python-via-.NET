...
sample_pptm = get_sample_file_path("sample.pptm")
...
sample_pdf_bookmarks = get_sample_file_path("sample_bookmarks.pdf")
...
output_doc_without_section_breaks = get_output_file_path("output_without_section_breaks.doc")
output_doc_without_starting_from_new_page = get_output_file_path("output_without_starting_from_new_page.doc")
output_docx = get_output_file_path("output.docx")
output_docx_with_predefined_compliance_mode = get_output_file_path("output_with_predefined_compliance_mode.docx")
output_pptx = get_output_file_path("output.pptx")
output_pptm = get_output_file_path("output.pptm")
...
output_pdf_bookmarks = get_output_file_path("output_bookmarks.pdf")
output_pdf_permissions = get_output_file_path("output_permissions.pdf")
